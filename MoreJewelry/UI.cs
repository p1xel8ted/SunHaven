...
public static class UI
{
    ...
    internal static void UpdateNavigationElements()
    {
        ...
        {
            Plugin.LOG.LogError("GearSlots count is not 6 indicating something went wrong creating the custom slots. Skipping navigation element update. Please report this.");
            return;
        }
