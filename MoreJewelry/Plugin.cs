...
public class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        IgnoreToggleWithController = Config.Bind("01. General", "Ignore Toggle With Controller", true, new ConfigDescription("Ignore toggle with controller.", null, new ConfigurationManagerAttributes {Order = 3}));
